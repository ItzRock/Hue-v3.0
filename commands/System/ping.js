exports.run = async (client, message, args, level) => {
    ...
    try{
        ...
        const data = await client.apis.https.get("https://api.itzrock.xyz/testthiswontwork")
